...
public class GasController implements Initializable {
	...
	@FXML
	private BarChart<String, Number> barChartGas;
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		barXAxis = (CategoryAxis) barChartGas.getXAxis();
		barYAxis = (NumberAxis) barChartGas.getYAxis();
		barChartGas.setTitle("ConsumeOfMonth");
		...
		tl.getKeyFrames().add(new KeyFrame(Duration.millis(1000),
			  (event) -> {
				  for (XYChart.Series<String, Number> series : barChartGas.getData()) {
