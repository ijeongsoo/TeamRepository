...
public class LoginCheckAspect {
	@Pointcut("execution(public * com.mycompany.myapp.controller.NotNeedSessionController.*(..))" )
	private void noSession(){}
	
	@Pointcut("execution(public * com.mycompany.myapp.controller.NeedSessionController.*(..))" )
