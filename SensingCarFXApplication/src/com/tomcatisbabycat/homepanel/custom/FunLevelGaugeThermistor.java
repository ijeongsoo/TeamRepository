...
package com.tomcatisbabycat.homepanel.custom;
 ...
 * Time: 13:19
 */
public class FunLevelGaugeThermistor extends Region {
    ...
    // ******************** Constructors **************************************
    public FunLevelGaugeThermistor() {
...
//        updateInterval  = 40_000_000l;     // Wave update interval
    ...
    private void initGraphics() {
        ...
        text = new Text(String.format(Locale.US, "%.00f%%", gauge.getCurrentValue()));
    ...
    public void setLevel(final double LEVEL) {
        ...
        for( int i = 0 ; i < detail + 1 ; i++ ) {
            p = particles.get(i);
            p.y = size * (1d - (LEVEL / 100));
            p.originalY = p.y;
        }
        text.setText(String.format(Locale.US, "%.00f", LEVEL));
        text.setX((size - text.getLayoutBounds().getWidth()) * 0.5);
        text.setFill(LEVEL < 40 ? darkerColor : brighterColor);
    }
	...
	protected void finalize() throws Throwable {
		System.out.println("FunLevelGaugeThermistor is OUT");
	}
